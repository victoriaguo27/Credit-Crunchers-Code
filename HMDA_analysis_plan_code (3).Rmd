...
iii) Interaction between Loan to income ratio and Property Type - We can observe that loans for home improvements are associated with a lower loan to income ratio as compared to those meant for home purchase or refinancing since home improvement loans are usually smaller loan amounts meant for minor changes. Moreover, in the case of denials, the distribution of loan to income ratio for home purchases is slightly more left skewed as compared to loans for refinancing which indicates that a higher loan to income ratio corresponds to more denials in the case of home purchases as compared to refinancing. This indicates a possible interaction between loan to income ratio and property type.
